...
namespace D1
{
    void Topic_2D::publishScanLaser(rclcpp::Publisher<sensor_msgs::msg::LaserScan>::SharedPtr &publisher_laserscan_, sensor_msgs::msg::LaserScan::SharedPtr message_laserscan_,
    ...
    void Topic_2D::publishPoint2D(rclcpp::Publisher<sensor_msgs::msg::PointCloud2>::SharedPtr &publisher_point_2d_, pcl::PointCloud<pcl::PointXYZRGBA>::Ptr pointcloud_2d_,
